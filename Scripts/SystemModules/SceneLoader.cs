...
public class SceneLoader : PersistentSingleton<SceneLoader>
{
    ...
    const string SELECTCHARACTERUI = "SelectCharacterUI";

    const string GAMEPLAY1 = "GamePlayer 1";

    const string GAMEPLAY2 = "GamePlayer 2";

    const string GAMEPLAY3 = "GamePlayer 3";

    const string MAIN_MENU = "GameStart";
    ...
    public void LoadSelectCharacterUIScene()
    {
        StopAllCoroutines();
        StartCoroutine(LoadingCoroutine(SELECTCHARACTERUI));
    }

    public void LoadGameplay1Scene()
    {
        StopAllCoroutines();
        StartCoroutine(LoadingCoroutine(GAMEPLAY1));
    }

    public void LoadGameplay2Scene()
    {
        StopAllCoroutines();
        StartCoroutine(LoadingCoroutine(GAMEPLAY2));
    }

    public void LoadGameplay3Scene()
    {
        StopAllCoroutines();
        StartCoroutine(LoadingCoroutine(GAMEPLAY3));
    }
